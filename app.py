...
st.write("Arraste o arquivo CSV do sistema para gerar o relatório com os IDs, Atendentes, Tabulações e Comentários.")
...
if uploaded_file is not None:
    ...
    if 'feedback_score' in df.columns:
        ...
        # Tratamento da nova coluna de comentários
        if 'feedback_text' in df.columns:
            bad_ratings['Comentário'] = bad_ratings['feedback_text'].fillna('Sem comentário')
        else:
            bad_ratings['Comentário'] = 'Sem comentário'
